...
const Blog = () => {
    ...
    return (
        <>
            <div className="blog-banner pt-24 px-20 bg-[url('https://cdn.pixabay.com/photo/2017/09/16/16/09/sea-2755908_960_720.jpg')] h-[60vh] relative z-80 flex justify-center items-center" >
                <div className='z-50'>
