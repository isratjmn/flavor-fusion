			...
			<div className="grid lg:grid-cols-3 sm:grid-cols-2 gap-10 mb-8 mx-auto w-full max-w-screen-xl">
				...
				<div className="grid grid-cols-2">
					...
					<div>
						...
						<ul className="mb-6 text-base font-semibold dark:text-white">
							<li className="mb-2 flex gap-2 items-center"> <FaMapMarkerAlt/>
								150 Duffy Ave, Hicksville, NY 11801, USA
							</li>
							<li className="mb-2 flex gap-2 items-center">
								{" "}
								<FaPhoneAlt /> +38 056 23 15 7851
							</li>
							<li className="mb-2 flex gap-2 items-center"><FaPhoneAlt /> +1 234 56 48 7898</li>
							<li className="mb-2 flex gap-2 items-center"> <FaRegEnvelope/>fusion.info@mail.com</li>
						</ul>
					</div>
				</div>
				<div>
