		...
		<footer className="section bg-gray-800 text-white">
				...
				<div className="grid grid-cols-2">
					...
					<div>
						...
						<ul className="mb-6 text-base font-semibold dark:text-white">
							...
							<li className="mb-2">+38 056 23 15 7851</li>
							<li className="mb-2">+1 1234 56 48 7898</li>
							<li className="mb-2">fusion.info@mail.com</li>
						</ul>
					</div>
				</div>
				<div>
			...
			<div className="sm:flex sm:items-center sm:justify-between">
				<span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
					<div className="pb-8">
						Copyright &#169;{" "}
						<span className="font-bold">IzmTechz</span>. All rights
						deserved.
					</div>
				</span>
			...
			{/* <footer className="dark:bg-gray-900 main-container">
				<section className="mx-auto w-full max-w-screen-xl container p-4 py-6 lg:py-8">
					<div className="md:flex md:justify-between">
						<div className="">
							...
							<p>
								{" "}
								We are a team of Professional cooks who are
								excited about their food, amazing skills and
								expertiness in cooking.
							</p>
						</div>
